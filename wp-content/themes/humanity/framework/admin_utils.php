...
function dttheme_default_option() {
	...
	$general = array(
				...
				"enable-welcome-text-code" => "on",
				"welcome-text"		=>"[dt_sc_upcoming_events_carousel limit='3' excerpt_length='30'/]
[dt_sc_hr_invisible_very_small] 
<a href='#' class='simple_link'>View all Events <span class='fa fa-angle-right'></span></a>[dt_sc_hr_invisible_medium]
<h1>Being Millionaire or a successful entrepreneur is not great, being human & Humanity is the greatest of all. Show a little compassion to your fellow beings.</h1> [dt_sc_button type='with-icon' icon='fa-angle-right' link='#' size='large' variation='palebrown' target='_blank'  data_delay='300' data_animation='fadeInLeft']Donate Now[/dt_sc_button]  [dt_sc_button type='with-icon' icon='fa-angle-right' link='#' size='large' variation='mustard' target='_blank'  data_delay='300' data_animation='fadeInLeft']View Our Cause[/dt_sc_button] ",
				"copyright-text" => 'Humanity &copy; 2015. Design by Design Themes');
