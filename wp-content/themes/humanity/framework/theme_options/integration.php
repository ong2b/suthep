...
<div id="integration" class="bpanel-content">
    ...
    <div class="bpanel-main-content">
        <ul class="sub-panel">   
            ...
            <li><a href="#integration-portfolio"><?php _e("Gallery",'dt_themes');?></a></li>
        </ul>
        ...
        <div id="integration-general">
        	<?php $integration_general = array( 
					array(
						...
						"tooltip"=>		__('Any java script custom code you can place here will appear in the head section of every page of your site.ex: alert("test")','dt_themes'),
					...
					array(
						...
						"tooltip"=>		__('Any java script custom code you can place here will appear in the Body section of every page of your site.ex: alert("test")','dt_themes'), 
						"textarea"=>	"body-code",
				...
				foreach($integration_post as $i_post): ?>
                    ...
                    <div class="bpanel-box">
                        ...
                        <div class="box-content">
                            ...
                            <div class="hr_invisible"></div>
                            <div class="hr_invisible"></div>
                    	<textarea id="mytheme[integration][<?php echo esc_html($i_post['textarea'])?>]"  name="mytheme[integration][<?php echo esc_attr($i_post['textarea'])?>]"><?php echo stripslashes(dttheme_option('integration',$i_post['textarea']));?></textarea>
                    	</div><!-- .box-content end-->
                </div><!-- .bpanel-box end-->
        <?php	endforeach;?>
                         ...
                         <label><?php echo esc_html($social_bookmark["label"]);?></label>
                            ...
                            <?php if( array_key_exists("options",$social_bookmark)):?>
                                ...
                                <?php 	foreach($social_bookmark['options'] as $key => $value):
                                            ...
                                            <option value="<?php echo esc_attr($key)?>" <?php echo esc_attr($rs);?>><?php echo esc_html($value)?></option>
                                <?php	endforeach;?>
                                </select>                                
                            <?php endif;?>
                            ...
                            <?php if(array_key_exists("color-scheme",$social_bookmark)): ?>
                                ...
                                <select name="mytheme[integration][<?php echo "post-".$social_bookmark['id']."-color-scheme";?>]">
                                    <?php foreach($social_bookmark['color-scheme'] as $options):
                                            ...
                                            <option value="<?php echo esc_attr($options)?>" <?php echo esc_attr($rs);?>><?php echo esc_html($options)?></option>
                                    <?php endforeach;?>
                                </select>
                            <?php endif;?>
