            ...
            <div class="bpanel-box">
                ...
                <div class="box-content">
                    ...
                    <div class="bpanel-option-set">
						...
						$custom_post_types = array( 'post' => 'Post', 'page' => 'Page', 'dt_galleries' => 'Galleries');
                        ...
                        foreach ( $custom_post_types as $post_type_key => $post_type_name ){
							...
							?>
                            <div class="column one-third"><label><?php echo esc_html($post_type_object->labels->singular_name); ?></label></div>
                            <div class="column two-third last">
                                 <div data-for="mytheme-<?php echo esc_attr($post_type_key);?>" class="checkbox-switch <?php echo esc_attr($switchclass);?>"></div>
                                 <input class="hidden" id="mytheme-<?php echo esc_attr($post_type_key);?>" name="mytheme[pagebuilder][<?php echo esc_attr($post_type_key);?>]" type="checkbox" value="<?php echo esc_attr($post_type_key);?>"
