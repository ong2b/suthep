        ...
        <div id="appearance-header" class="tab-content">
        	<div class="bpanel-box">
                ...
                <div class="box-content">
                    <h6><?php _e('Enter Donate Now Button Link','dt_themes');?></h6>
                    <div class="column one-column">
                        <input id="mytheme-donate-button-link" name="mytheme[appearance][donate-button-link]" type="text" value="<?php echo dttheme_option('appearance','donate-button-link'); ?>" />
                    </div>
                    <div class="column one-half last">
                        <p class="note no-margin"><?php _e('Enter donate now button link here.','dt_themes'); ?></p>
                    </div>
                </div>
              <!-- Header -->
          </div>
        ...
        <div id="appearance-menu" class="tab-content">
            ...
            <div class="box-content">
              ...
              <div class="bpanel-option-set">
                ...
                <p class="note"> <?php _e('Switch "YES" to Disable, "NO" to Enable the Menu Settings.','dt_themes');?>  </p>                        
              </div>
        	...
        	<div class="bpanel-box">
                ...
                <div class="box-content">
                    ...
                    <div class="bpanel-option-set">
                        ...
                        <p class="note"> <?php _e('Switch "YES" to Disable, "NO" to Enable the Body Settings.','dt_themes');?>  </p>
                    </div>    
        	...
        	<div class="bpanel-box">
                ...
                <div class="box-content">
                    ...
                    <div class="bpanel-option-set">
                        ...
                        <p class="note"><?php _e('Switch "YES" to Disable, "NO" to Enable the Footer Settings.','dt_themes');?>  </p>
                    </div>
        ...
        <div id="appearance-layout" class="tab-content">
	        ...
	        <div class="bpanel-box">
                ...
                <div class="box-content">
                	...
                	<p class="note no-margin"> <?php _e("Here, You can Choose a suitable Layout for the Website. Boxed and Full-width Versions Available.","dt_themes");?> </p>
                    <div class="hr_invisible"> </div>
					<div class="bpanel-option-set">    
                         <ul class="bpanel-post-layout bpanel-layout-set">
                         	<?php $layouts = array("boxed","wide");
								  foreach($layouts as $layout):
                                  	...
                                  	<li class="themelayout"><a href="#" rel="<?php echo esc_attr($layout);?>" class=" <?php echo esc_attr($class);?>" title="<?php echo esc_attr($layout);?>">
                    ...
                    <div class="bg-pattern" style=" <?php echo esc_attr($bg_pattern);?>">
                    	...
                    	<div class="bpanel-option-set">
                            ...
                            <?php $pattrens  = dttheme_listImage(IAMD_FW."theme_options/images/patterns/");
								foreach($pattrens as $key => $value):
									...
									echo "<li>";
									echo "<a href='#' rel='{$key}' class='{$class}'><img width='80px' height='80px' src='".IAMD_FW_URL."theme_options/images/patterns/$key' /></a>";
									echo "</li>";
								endforeach;?></ul>
                        ...
                        <?php $label = 		__("Choose Background Color",'dt_themes');
                              ...
                              $tooltip = 	__("Pick a custom background color of the theme.(e.g. #a314a3)",'dt_themes');
                                ...
                                <p class="note"> <?php echo esc_attr($tooltip);?></p>
                        </div>
                        ...
                        <?php $bg_settings = array(
                              ...
                              foreach($bg_settings as $bgsettings): ?>
                                  <div class="bpanel-option-set">
                                    ...
                                    <p class="note"> <?php echo esc_attr($bgsettings['tooltip']);?>  </p>
                                    <div class="hr_invisible"> </div>
                                  </div>
                        <?php endforeach;?>
                        		 <div class="bpanel-option-set">	
