...
<div id="specialty-pages" class="bpanel-content">
    ...
    <div class="bpanel-main-content">
         ...
         <?php $posts_layout_array =   array( 'post-thumb' => __("Post Thumb","dt_themes") );
                    ...
                    <div class="box-content">
                    	...
                    	<div class="bpanel-option-set">
							...
							foreach($layout as $key => $value):
								$class = ( $key ==  dttheme_option('specialty',"{$id}-layout")) ? "selected" : "";
                            ...
                            $cs = ( $cs == "content-full-width" ) ? "display:none;" : "";?>
                        <div class="widgetarea-section" style=' <?php echo esc_attr($cs);?>'>
                            <div class="hr"></div>
                            <div class="bpanel-option-set">
