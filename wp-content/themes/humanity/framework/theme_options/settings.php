           	...
           	<div id="bpanel">
                	...
                	<div id="bpanel-left">
                    	...
                    	<div id="logo"><?php
							...
							<img src="<?php echo esc_attr($logo);?>" width="186" height="101" alt="" title="" />
						</div>
                    ...
                    <form id="mytheme_options_form" name="mytheme_options_form" method="post" action="options.php">
                        ...
                        <div class="top-links">
	                        ...
	                        <a class="mytheme-import-button bpanel-button blue-btn <?php echo esc_attr($import_disable);?>"><?php _e('Import Dummy Data','dt_themes');?></a>
                        </div><?php 
