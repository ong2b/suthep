            ...
            <div class="bpanel-box">
                ...
                <div class="box-content">
                    ...
                    <div class="bpanel-option-set">
                        ...
                        <?php foreach($footer_layouts as $k => $v): $class = ( $k ==  dttheme_option('general','footer-columns')) ? "selected" : "";?>
                       		<li><a href="#" rel="<?php echo esc_attr($k);?>" class=" <?php echo esc_attr($class);?>"><img src="<?php echo IAMD_FW_URL."theme_options/images/columns/{$v}.png";?>" /></a></li>	
                        <?php endforeach;?>
