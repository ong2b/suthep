    ...
    <div class="bpanel-main-content">
        ...
        <div id="my-general" class="tab-content">
            ...
            <div class="bpanel-box">
                    ...
                    <div class="box-title"><h3><?php _e('Welcome Message','dt_themes');?></h3></div>
                    <div class="box-content">
                    <h6><?php _e("Disable Welcome Message Code",'dt_themes')?></h6>
                    <div class="column one-fifth bpanel-option-set">
                        <?php dttheme_switch("",'general','disable-welcome-text');?>
                    </div>
                    <div class="column four-fifth last"><p class="note"><?php _e('Any code you can place here will appear in the Welcome Text section of Home page of your site.','dt_themes');?></p></div>
                    <div class="clear"></div>
                    <div class="hr_invisible"></div>
                    <div class="hr_invisible"></div>
                    <div class="welcome_textarea">
                    <textarea id="mytheme-welcome-text" name="mytheme[general][welcome-text]" rows="" 
                                	cols=""><?php echo stripslashes(dttheme_option('general','welcome-text'));?></textarea>
                    </div>
                    <div class="hr"></div>
                    </div>
                    ...
                    <div class="box-content">
                        ...
                        <h6> <?php _e('Globally Enable Comments on Pages','dt_themes');?> </h6>
                        <div class="column one-fifth">
                            ...
                            <input class="hidden" id="mytheme-global-page-comment" name="mytheme[general][disable-page-comment]" type="checkbox" value="true" <?php echo esc_attr($checked);?> />
                        </div>
                        <div class="column four-fifth last">
                      	 <p class="note no-margin"><?php 
							_e('YES! to enable comments on all the pages. This will globally override your "Allow comments" option under your page "Discussion" settings. ','dt_themes');?> </p>
                        </div>
                      <div class="hr"></div>
                        ...
                        <div class="column one-fifth">
                            ...
                            <input class="hidden" id="mytheme-global-post-comment" name="mytheme[general][global-post-comment]" type="checkbox" value="true" <?php echo esc_attr($checked);?> />
                        </div>
                        <div class="column four-fifth last">
                        ...
                        <select id="mytheme-breadcrumb-delimiter" name="mytheme[general][breadcrumb-delimiter]"><?php 
					  	$breadcrumb_icons = array('fa-angle-right','fa-angle-double-right','fa-sort','fa-ok','fa-caret-right','fa-double-angle-right','fa-arrow-right','fa-chevron-right','fa-hand-right','fa-plus','fa-remove');
