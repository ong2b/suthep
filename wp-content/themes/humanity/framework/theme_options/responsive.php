                ...
                <div class="box-content">
	                ...
	                <div class="one-half-content">
    	            	<div class="bpanel-option-set">
                          ...
                          <input class="hidden" id="is-theme-responsive" name="mytheme[mobile][is-theme-responsive]" type="checkbox" value="true" <?php echo esc_attr($checked);?> />
	                ...
	                <div class="one-half-content last">
    	            	<div class="bpanel-option-set">
                          ...
                          <input class="hidden" id="is-slider-disabled" name="mytheme[mobile][is-slider-disabled]" type="checkbox" value="true" <?php echo esc_attr($checked);?> />
