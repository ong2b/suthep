...
class MY_Recent_Pages extends WP_Widget {
	...
	function form($instance) {
	    ...
	    <p><label for="<?php echo esc_attr($this->get_field_id('_pages')); ?>">
			<?php _e('Choose the pages you want to display (multiple selection possible)','dt_themes');?></label>
            <select class="widefat" id="<?php echo esc_attr($this->get_field_id('_pages').'[]');?>" 
            	name="<?php echo esc_attr($this->get_field_name('_pages').'[]');?>" multiple="multiple">
