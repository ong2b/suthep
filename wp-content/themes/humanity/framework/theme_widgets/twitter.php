...
class MY_Twitter extends WP_Widget {
	...
	function form($instance) {
        ...
        <p><label for="<?php echo esc_attr( $this->get_field_id('consumer_key') ); ?>"><?php _e('Consumer Key:','dt_themes');?> 
        ...
        <p><label for="<?php echo esc_attr( $this->get_field_id('consumer_secret') ); ?>"><?php _e('Consumer Secret:','dt_themes');?> 
        ...
        <p><label for="<?php echo esc_attr( $this->get_field_id('access_token') ); ?>"><?php _e('Access Token:','dt_themes');?> 
        ...
        <p><label for="<?php echo esc_attr( $this->get_field_id('access_token_secret') ); ?>"><?php _e('Access Token Secret:','dt_themes');?> 
        ...
        <p><label for="<?php echo esc_attr( $this->get_field_id('username') ); ?>"><?php _e('Enter your twitter username:','dt_themes');?>
        ...
        <p><label for="<?php echo esc_attr( $this->get_field_id('count') ); ?>"><?php _e('How many entries do you want to show:','dt_themes');?>
        ...
        <p><input type="checkbox"  id="<?php echo esc_attr( $this->get_field_id('exclude_replies') );?>" name="<?php echo esc_attr( $this->get_field_name('exclude_replies') );?>" 
			<?php checked($exclude_replies); ?> /> <label for="<?php echo esc_attr( $this->get_field_id('exclude_replies') ); ?>"><?php _e('Exclude @replies','dt_themes');?></label></p>
            
        <p><input type="checkbox"  id="<?php echo esc_attr( $this->get_field_id('time') );?>" name="<?php echo esc_attr( $this->get_field_name('time') );?>" 
			<?php checked($time); ?> /> <label for="<?php echo esc_attr( $this->get_field_id('time') ); ?>"><?php _e('Show time of tweet','dt_themes');?></label></p>
            
        <p><input type="checkbox"  id="<?php echo esc_attr( $this->get_field_id('time') );?>" name="<?php echo esc_attr( $this->get_field_name('display_avatar') );?>" 
				<?php checked($display_avatar); ?> /> <label for="<?php echo esc_attr( $this->get_field_id('display_avatar') ); ?>"><?php _e('Show user avatar','dt_themes');?></label></p>		
<?php
	}
	...
	function widget($args, $instance) {
		...
		echo !empty( $before_widget ) ? $before_widget : '';			
			...
			if ( !empty( $title ) ) { echo !empty( $before_title ) ? $before_title . "<a href='http://twitter.com/$username/' title='".strip_tags($title)."'>".$title ."</a>". $after_title : ''; };
			
			#$messages = mytheme_get_tweet($count, $username, $time, $exclude_replies, $display_avatar);
			#echo esc_attr($messages);
