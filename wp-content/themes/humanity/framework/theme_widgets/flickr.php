...
class MY_Flickr extends WP_Widget {
	...
	function form($instance) {
        ...
        <p><label for="<?php echo esc_attr($this->get_field_id('flickr_id')); ?>"><?php _e('Flickr ID:','dt_themes');?>
        ...
        <p><label for="<?php echo esc_attr($this->get_field_id('count')); ?>"><?php _e('How many entries do you want to show:','dt_themes');?>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('show'));?>"><?php _e('What pictures to display','dt_themes'); ?>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('size'));?>"><?php _e('What pictures to display','dt_themes'); ?>
