		...
		<li id="menu-item-<?php echo esc_attr($item_id); ?>" class="<?php echo implode(' ', $classes ); ?>">
			<dl class="menu-item-bar">
				<dt class="menu-item-handle">
					<span class="item-title"><span class="menu-item-title"><?php echo esc_html( $title ); ?></span> <span class="is-submenu" <?php echo esc_attr($submenu_text); ?>><?php _e( 'sub item','dt_themes' ); ?></span></span>
			...
			<div class="menu-item-settings" id="menu-item-settings-<?php echo esc_attr($item_id); ?>">
				...
				<!-- DesignThemes Custom Code Begins Here-->
	                ...
	                <p class="field-dt-submenu-column description description-wide">
							...
							<?php _e( 'Sub Menu Column Layout' ,  'dt_themes' ); ?><br />
	                            ...
	                            <?php for( $i = 2; $i <= 4; $i++): ?>
	                              <option value="<?php echo esc_attr($i);?>" <?php selected( $value,$i);?>><?php echo esc_attr($i); ?></option>
	                            <?php endfor;?>
	                            </select>
				...
				<div class="menu-item-actions description-wide submitbox">
					...
					); ?>"><?php _e( 'Remove' ,'dt_themes'); ?></a> <span class="meta-sep hide-if-no-js"> | </span> <a class="item-cancel submitcancel hide-if-no-js" id="cancel-<?php echo esc_attr($item_id); ?>" href="<?php echo esc_url( add_query_arg( array( 'edit-menu-item' => $item_id, 'cancel' => time() ), admin_url( 'nav-menus.php' ) ) );
						?>#menu-item-settings-<?php echo esc_attr($item_id); ?>"><?php _e('Cancel','dt_themes'); ?></a>
				</div>
