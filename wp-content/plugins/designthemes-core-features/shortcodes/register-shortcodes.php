...
if (! class_exists ( 'DTCoreShortcodes' )) {
	...
	class DTCoreShortcodes {
		...
		function dt_the_content_filter($content) {
			$dt_shortcodes = array("dt_sc_accordion_group","dt_sc_button","dt_sc_blockquote","dt_sc_callout_box","dt_sc_callout_box_with_icon",
				...
				"dt_sc_five_sixth_inner","dt_sc_four_fifth_inner","dt_sc_address","dt_sc_contact","dt_sc_email",
				"dt_sc_donutchart_small","dt_sc_donutchart_medium","dt_sc_donutchart_large",
				"dt_sc_clear","dt_sc_hr_border","dt_sc_hr","dt_sc_hr_medium","dt_sc_hr_large","dt_sc_hr_invisible","dt_sc_hr_invisible_very_small","dt_sc_hr_invisible_small",
				"dt_sc_hr_invisible_medium","dt_sc_hr_invisible_large","dt_sc_hr_invisible_very_large","dt_sc_icon_box","dt_sc_fancy_ol","dt_sc_fancy_ul",
				"dt_sc_pricing_table","dt_sc_pricing_table_item","dt_sc_progressbar","dt_sc_tab","dt_sc_tabs","dt_sc_tabs_framed",
				"dt_sc_toggle","dt_sc_toggle_framed","dt_sc_titled_box","dt_sc_tooltip","dt_sc_pullquote",
				"dt_sc_team","dt_sc_testimonial","dt_sc_testimonial_carousel","dt_sc_carousel",
				"dt_sc_h1","dt_sc_h2","dt_sc_h3","dt_sc_h4","dt_sc_h5","dt_sc_h6","dt_sc_h1_title_with_icon","dt_sc_h2_title_with_icon","dt_sc_h3_title_with_icon",																  				"dt_sc_h4_title_with_icon","dt_sc_h5_title_with_icon","dt_sc_h6_title_with_icon",
				"dt_sc_post","dt_sc_recent_post","dt_sc_upcoming_events_carousel","dt_sc_gallery_item","dt_sc_recent_gallery_items","dt_sc_gallery_items_from_category",			        		"dt_sc_fullwidth_section","dt_sc_curved_title" );
