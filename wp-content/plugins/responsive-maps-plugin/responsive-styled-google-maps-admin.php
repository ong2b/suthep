            ...
            <table border="0" cellpadding="5" id="rsmaps">
                ...
                <tr>
                    ...
                    <td rowspan="15" valign="top" valign="top" width="600px">
                        ...
                        <a href="<?php echo plugins_url(); ?>/responsive-maps-plugin/documentation/index.html" class="button button-primary" target="_blank"><?php echo __('PLUGIN DOCUMENTATION') ?> </a>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <select name="searchbox" id="searchbox" onchange="updateMap(pluginurl)">
                            <option value='' selected>no</option>
                            <option value='true'>yes</option>
                        </select>
                        <?php echo __('Clustering') ?>
                        <select name='clustering' id='clustering' onchange="updateMap(pluginurl)">>
                            <option value='' selected>no</option>
                            <option value='true'>yes</option>
                        </select>
                        <?php echo __('Logging') ?>
                        <select name='logging' id='logging' onchange="updateMap(pluginurl)">>
                            <option value='' selected>no</option>
                            <option value='true'>yes</option>
                        </select>
                        <?php echo __('Points of interest') ?>
                        <select name='poi' id='poi' onchange="updateMap(pluginurl)">>
                            <option value='true' selected>yes</option>
                            <option value=''>no</option>
                        </select>
                        </td>
                ...
                <tr>
                    ...
                    <td>
                        <select name='popup' id="popup" onchange="updateMap(pluginurl)">
                            <option value='' selected><?php echo __('hidden') ?></option>
                            <option value='true'><?php echo __('visible') ?></option>
                        </select>
